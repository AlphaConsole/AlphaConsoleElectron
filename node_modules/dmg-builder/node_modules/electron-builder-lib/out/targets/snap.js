...
class SnapTarget extends (_core || _load_core()).Target {
    ...
    createDescriptor(snapName, arch) {
    ...
    build(appOutDir, arch) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            const snapFileName = `${snapName}_${packager.appInfo.version}_${(0, (_builderUtil || _load_builderUtil()).toLinuxArchString)(arch)}.snap`;
            const artifactPath = _path.join(_this.outDir, snapFileName);
            _this.logBuilding("snap", artifactPath, arch);
            const snap = _this.createDescriptor(snapName, arch);
